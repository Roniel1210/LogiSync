...
import { ArrowUpRight, ArrowDownRight, MoreVertical, Calendar, Download } from 'lucide-react';
import { cn } from '../lib/utils';
import { motion } from 'motion/react';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, PieChart, Pie, Cell } from 'recharts';

const kpis = [
  { label: "Sincronización Inventario", value: "98.4%", change: "+2.1%", trend: "up", subtitle: "Vs mes anterior" },
  { label: "SLA de Entregas", value: "96.5%", change: "+0.5%", trend: "up", subtitle: "Vs mes anterior" },
  { label: "Optimización Compras", value: "$42.5k", change: "-1.5%", trend: "down", subtitle: "Vs mes anterior" },
...
const deviceData = [
  { name: 'Terrestre', value: 65, color: '#4f46e5' },   // Indigo
  { name: 'Aéreo', value: 20, color: '#8b5cf6' },      // Violet
  { name: 'Marítimo', value: 15, color: '#c4b5fd' },   // Light Violet
];
  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-xl shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] border border-slate-100/60 p-6">
        ...
        <div className="h-[300px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={analyticsData} margin={{ top: 0, right: 0, left: -20, bottom: 0 }} barSize={12}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Recent Quotes Table - spans 2 cols */}
        <div className="lg:col-span-2 bg-white rounded-xl shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] border border-slate-100/60 p-6 flex flex-col">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg font-bold text-slate-800">Evaluación de Cotizaciones</h2>
        ...
        {/* Transport Type Distribution (Donut Chart) */}
        <div className="col-span-1 bg-white rounded-xl shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] border border-slate-100/60 p-6 flex flex-col">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-lg font-bold text-slate-800">Distribución de Carga</h2>
